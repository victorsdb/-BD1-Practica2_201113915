...
-- Llenando Tabla XXX
-- ======================================================================================             
SELECT Id_Victima, Id_Asociado, Count(Fecha_Conocio) FROM                
(
SELECT DISTINCT Id_victima, Nombre_victima, Apellido_victima,Id_asociado, Nombre_asociado, Apellido_asociado, Fecha_conocio 
        FROM Registro
            INNER JOIN Victima ON Victima.Nombre = Nombre_Victima AND Victima.Apellido = Apellido_Victima
...
GROUP BY Id_Victima, Id_Asociado
    HAVING COUNT(Fecha_Conocio) >1;
